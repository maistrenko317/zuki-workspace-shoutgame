...
{
    private static TrustManagerFactory nullFactory = null;
		...
		if(trustManager == null) {
		    ...
		    if (keystore == null) {
		        if (nullFactory == null) {
		            ...
		            nullFactory = TrustManagerFactory.getInstance(TrustManagerFactory.getDefaultAlgorithm());
		            nullFactory.init(keystore);
		        }
