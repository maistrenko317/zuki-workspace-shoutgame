...
class HttpClientWebRequest extends HttpWebRequest {
	...
	//-
	public void setExchangeCookie(String exchangeCookie)
	{
	...
	public void prepareConnection() throws EWSHttpException {
		...
		if (getPreferredWebAuthMethod() != null)
		    authPrefs.add(getPreferredWebAuthMethod());
        if (!AuthPolicy.NTLM.equals(getPreferredWebAuthMethod()))
            authPrefs.add(AuthPolicy.NTLM);
		if (!AuthPolicy.BASIC.equals(getPreferredWebAuthMethod()))
		    authPrefs.add(AuthPolicy.BASIC);
        if (!AuthPolicy.DIGEST.equals(getPreferredWebAuthMethod()))
		...
		if(getProxy() != null) {
		    System.out.println("Setting proxy to " + getProxy().getHost() + ":" + getProxy().getPort());
		...
		if (this.exchangeCookie != null) {
		    httpMethod.setRequestHeader("Cookie", "exchangecookie=" + this.exchangeCookie);
		}
