...
public interface IDaoMapper
{
    ...
    @Insert(
        ...
        ") VALUES (" +
        "   #{name}, #{basePlayerCount}, #{entranceFeeAmount}, #{creatorId}, #{createDate}" +
        ")"
    )
    ...
    @Update(
        "UPDATE snowyowl.payout_model SET `name` = #{name}, base_player_count = #{basePlayerCount}, entrance_fee_amount = #{entranceFeeAmount} " +
