...
public class TeamSubscriberRequiresUpdateException extends RuntimeException implements DomainException {
	private static final long serialVersionUID = 1L;
	
  private Map<String, Object> _domainMap = new HashMap<String, Object>(1);
	
  public TeamSubscriberRequiresUpdateException() {
    super();
  }

  public TeamSubscriberRequiresUpdateException(String message) {
    super(message);
  }
