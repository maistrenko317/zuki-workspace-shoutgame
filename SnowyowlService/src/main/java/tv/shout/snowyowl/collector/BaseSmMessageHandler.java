...
implements GamePublisher
{
    ...
    private static DefaultTransactionDefinition txDef;
    ...
    public static Object wrapInTransaction(PlatformTransactionManager transactionManager, Function<Object, Object> transactionalMethod, Object params)
    {
        ...
        if (txDef == null) {
            txDef = new DefaultTransactionDefinition(TransactionDefinition.PROPAGATION_NESTED);
        }
    ...
    {
        publishGameWithExtrasToWds(gameId, (PayoutModel)null, null, null);
    }
