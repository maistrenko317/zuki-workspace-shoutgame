...
public class MockHandlerBeginPoolPlay
extends HandlerBeginPoolPlay
{
    private static Logger _logger = Logger.getLogger(MockHandlerBeginPoolPlay.class);

    public MockHandlerBeginPoolPlay(
            MessageBus messageBus, IDaoMapper dao,
            IIdentityService identityService, IShoutContestService shoutContestService, MatchMaker matchMaker, BotEngine botEngine, SponsorEngine sponsorEngine)
    {
