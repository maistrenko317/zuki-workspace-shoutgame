...
#fab install_services:start=0 install_webapps:start=0 mrsoa_start -Rdc1-sync,dc1-collector -P
#fab install_services:start=1 -Rdc1-sync,dc1-collector -P
...
#fab install_services:name="$1",start=0 mrsoa_start -Rdc1-sync,dc1-collector -P
